End this session and promote speculative insights to confirmed.
...
3. If 5 or more entries were promoted, run the consolidation steps:
   ...
   - Review flagged entries: stale maps, never-accessed entries, low-confidence items, orphaned speculative entries.
